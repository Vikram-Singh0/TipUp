...
function TipCreatorPageContent() {
  ...
  const handleTip = async () => {
    if (!tipAmount || !isConnected || !account) {
      setError(
        "Please connect your Push Universal Account and enter a tip amount"
      );
      return;
    }
    ...
    try {
      ...
      // Send the tip transaction using Push Universal Account
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        <Card className="bg-card/50 backdrop-blur">
          ...
          <CardContent className="space-y-4">
            ...
            >
              {!isConnected || !account ? (
                "Connect Push Universal Account First"
              ) : isLoading ? (
